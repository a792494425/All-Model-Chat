...
const shellFeatureTranslations: TranslationMap = {
  ...
  settingsTitle: { en: 'Settings', zh: '设置', ja: '設定', ko: '설정', es: 'Ajustes', fr: 'Paramètres', de: 'Einstellungen' },
  ...
  settingsMediaResolution: { en: 'Input Detail Level', zh: '输入细节等级', ja: '入力の詳細レベル', ko: '입력 세부 수준', es: 'Nivel de detalle de entrada', fr: 'Niveau de détail d\'entrée', de: 'Detailgrad der Eingabe' },
  // CamelCase labels used by MediaResolutionSelector on the chat chrome.
  mediaResolutionUnspecified: { en: 'Auto (Default)', zh: '自动（默认）', ja: '自動（デフォルト）', ko: '자동 (기본값)', es: 'Automático (predeterminado)', fr: 'Auto (par défaut)', de: 'Automatisch (Standard)' },
  mediaResolutionLow: { en: 'Low (Faster)', zh: '低（较快）', ja: '低（高速）', ko: '낮음 (빠름)', es: 'Bajo (más rápido)', fr: 'Faible (plus rapide)', de: 'Niedrig (schneller)' },
  mediaResolutionMedium: { en: 'Medium (Balanced)', zh: '中（平衡）', ja: '中（バランス）', ko: '중간 (균형)', es: 'Medio (equilibrado)', fr: 'Moyen (équilibré)', de: 'Mittel (ausgewogen)' },
  mediaResolutionHigh: { en: 'High (Detail)', zh: '高（细节）', ja: '高（詳細）', ko: '높음 (세부 묘사)', es: 'Alto (detallado)', fr: 'Élevé (détaillé)', de: 'Hoch (detailliert)' },
  mediaResolutionUltraHigh: { en: 'Ultra High (Images only)', zh: '超高（仅限图片）', ja: '超高（画像のみ）', ko: '매우 높음 (이미지만)', es: 'Ultra alto (solo imágenes)', fr: 'Ultra élevé (images uniquement)', de: 'Ultrahoch (nur Bilder)' },
  // PWA update banner (always available).
  aboutUpdateReady: { en: 'Update ready to refresh', zh: '发现可用更新', ja: '更新の準備ができました', ko: '새로고침하여 업데이트 준비 완료', es: 'Actualización lista para recargar', fr: 'Mise à jour prête à être installée', de: 'Update bereit zum Aktualisieren' },
  pwaUpdateRefreshPrompt: {
    en: 'Refresh to update the installed shell and latest assets.',
    zh: '刷新以更新已安装的应用外壳和最新资源。',
    ja: '再読み込みすると、インストール済みのシェルと最新のアセットが更新されます。', ko: '새로고침하여 설치된 셸과 최신 리소스를 업데이트하세요.', es: 'Actualiza para renovar el shell instalado y los recursos más recientes.', fr: 'Actualisez pour mettre à jour le shell installé et les dernières ressources.', de: 'Neu laden, um die installierte Shell und die neuesten Ressourcen zu aktualisieren.',
  },
