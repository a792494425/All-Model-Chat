...
const shellFeatureTranslations: TranslationMap = {
  ...
  settingsMediaResolution: { en: 'Input Detail Level', zh: '输入细节等级', ja: '入力詳細レベル', ko: '입력 세부 수준', es: 'Nivel de detalle de entrada', fr: 'Niveau de détail d\'entrée', de: 'Detailgrad der Eingabe' },
  ...
  aboutUpdateReady: { en: 'Update ready to refresh', zh: '发现可用更新', ja: '更新の準備ができました', ko: '새로고침하여 업데이트 준비 완료', es: 'Actualización lista para recargar', fr: 'Mise à jour prête à actualiser', de: 'Update bereit zum Aktualisieren' },
  pwaUpdateRefreshPrompt: {
    en: 'Refresh to update the installed shell and latest assets.',
    zh: '刷新以更新已安装的应用外壳和最新资源。',
    ja: '更新して、インストール済みのシェルと最新のアセットを更新します。', ko: '새로고침하여 설치된 셸과 최신 리소스를 업데이트하세요.', es: 'Actualiza para renovar el shell instalado y los recursos más recientes.', fr: 'Actualisez pour mettre à jour le shell installé et les dernières ressources.', de: 'Aktualisieren, um die installierte Shell und die neuesten Ressourcen zu aktualisieren.',
  },
