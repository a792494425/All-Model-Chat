export const headerTranslations = {
  ...
  liveArtifactsPromptInactiveAria: {
    ...
    ja: 'Live Artifactsプロンプトを読み込む', ko: 'Live Artifacts 프롬프트 불러오기', es: 'Cargar prompt de Live Artifacts', fr: 'Charger le prompt Live Artifacts', de: 'Live Artifacts-Prompt laden',
  },
  ...
  headerThinkingLowFastTitle: { en: 'Thinking: Low (Fast Mode)', zh: '思考：低（快速模式）', ja: '思考：低（高速モード）', ko: '사고: 낮음 (빠른 모드)', es: 'Pensamiento: Bajo (Modo rápido)', fr: 'Réflexion: Faible (Mode rapide)', de: 'Thinking: Niedrig (Schnellmodus)' },
  headerThinkingHighTitle: { en: 'Thinking: High (Pro Mode)', zh: '思考：高（专业模式）', ja: '思考：高（プロモード）', ko: '사고: 높음 (프로 모드)', es: 'Pensamiento: Alto (Modo Pro)', fr: 'Réflexion: Élevée (Mode Pro)', de: 'Thinking: Hoch (Pro-Modus)' },
};
