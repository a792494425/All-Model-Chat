...
type StandardMarkdownRendererProps = ComponentProps<typeof StandardMarkdownRenderer>;

const baseProps: StandardMarkdownRendererProps = {
...
describe('MarkdownRendererCore CodeBlock remount regression', () => {
  ...
  const renderBlock = (props: StandardMarkdownRendererProps) => {
    act(() => {
      renderer.render(<StandardMarkdownRenderer {...props} />);
    });
  };
