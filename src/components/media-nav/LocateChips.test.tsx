...
describe('LocateChips', () => {
  ...
  it('renders nothing without locates', () => {
    const { container } = render(<LocateChips messageId="m" pdfLocates={[]} videoLocates={[]} />);
  ...
  it('renders a segment chip that carries the loop bounds', () => {
    seedSession([makeVideo()]);
    render(<LocateChips messageId="m" pdfLocates={[]} videoLocates={[{ startSeconds: 60, endSeconds: 90 }]} />);
