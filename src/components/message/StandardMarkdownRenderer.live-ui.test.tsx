...
describe('StandardMarkdownRenderer Live Artifacts', () => {
  const renderer = setupTestRenderer();
  const renderMarkdown = (props: StandardMarkdownRendererTestProps) => renderStandardMarkdown(renderer.root, props);
