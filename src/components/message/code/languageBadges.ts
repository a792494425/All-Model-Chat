// Language badge registry and configuration mappings
// Extracted from LanguageIcon.tsx for clean UI component separation
...
export type FallbackIcon = 'braces' | 'workflow';

export type LanguageBadgeEntry = {
  aliases: string[];
  badgeId: string;
  displayName: string;
  compactLabel?: string;
...
export type LanguageBadgeConfig = {
  badgeId: string;
  iconId: string;
  displayName: string;
  compactLabel?: string;
...
export const getLanguageBadgeConfig = (language: string): LanguageBadgeConfig => {
