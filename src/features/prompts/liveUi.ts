...
- Metric cards: ≤3 quantifiable values. Stripe/Linear layout: uppercase micro-label (font-size:0.72em;letter-spacing:0.04em;color:var(--amc-live-artifact-muted);) + dominant hero number (font-size:1.8em~2.2em;font-weight:800;letter-spacing:-0.04em;font-variant-numeric:tabular-nums;) with baseline-aligned unit (font-size:0.55em;font-weight:500;color:var(--amc-live-artifact-muted);) and optional DeltaBadge + contextual subtext (font-size:0.75em;color:var(--amc-live-artifact-muted);). Sibling metric cards must hug content cleanly without large hollow gaps. The value slot accepts a quantifiable number only; never put a phrase or sentence there; keep value text ≤ 8 characters. Metric thematic coherence: sibling metric cards (2–3 cards) must belong to the same analytical dimension.
...
- Table: modern clean thead: font-size:0.8em;font-weight:600;letter-spacing:0.02em;color:var(--amc-live-artifact-muted);border-bottom:1px solid var(--amc-live-artifact-border); (never thick 2px borders); tables with >4 rows should declare thead style="position:sticky;top:0;z-index:1;background:var(--amc-live-artifact-surface-muted);" so headers stay visible during vertical scroll; cell borders border token; wrap wide tables in overflow-x:auto; td/th default to vertical-align:top; short status/tag columns must declare white-space:nowrap. Anti-pill fatigue: never flood comparison tables with badges in every single row; highlight winners with semibold text and subtle dot (e.g. ● Kafka) or subtle row tint (e.g. success-surface); reserve pill badges strictly for genuine status transitions (e.g. Adopt/Deprecate).
...
<div style="display:block;width:100%;box-sizing:border-box;max-width:100%;overflow-wrap:anywhere;">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,12em),1fr));align-items:stretch;gap:0.75rem;margin-bottom:1rem;">
    <div style="background:var(--amc-live-artifact-surface-muted);border:1px solid var(--amc-live-artifact-border);box-shadow:inset 0 1px 0 0 rgba(255,255,255,0.06);border-radius:0.5rem;padding:0.75rem 0.9rem;display:flex;flex-direction:column;justify-content:space-between;box-sizing:border-box;height:100%;">
      ...
      <div style="font-size:1.8em;font-weight:800;letter-spacing:-0.04em;font-variant-numeric:tabular-nums;margin:0.25rem 0 0.15rem;display:flex;align-items:baseline;gap:0.4rem;">120k <span style="font-size:0.55em;font-weight:500;color:var(--amc-live-artifact-muted);">msg/s</span> <span style="font-size:0.45em;font-weight:600;padding:0.12em 0.45em;border-radius:9999px;background:var(--amc-live-artifact-success-surface);color:var(--amc-live-artifact-success);border:1px solid var(--amc-live-artifact-success);letter-spacing:0;">+18% &uarr;</span></div>
  ...
  <table style="width:100%;border-collapse:collapse;font-size:0.875em;line-height:1.5;">
    <thead style="position:sticky;top:0;z-index:1;"><tr style="background:var(--amc-live-artifact-surface-muted);"><th style="text-align:left;padding:0.5em 0.75em;border-bottom:1px solid var(--amc-live-artifact-border);font-size:0.8em;font-weight:600;letter-spacing:0.02em;color:var(--amc-live-artifact-muted);">Engine</th><th style="text-align:right;padding:0.5em 0.75em;border-bottom:1px solid var(--amc-live-artifact-border);font-size:0.8em;font-weight:600;letter-spacing:0.02em;color:var(--amc-live-artifact-muted);">Memory</th><th style="text-align:left;padding:0.5em 0.75em;border-bottom:1px solid var(--amc-live-artifact-border);font-size:0.8em;font-weight:600;letter-spacing:0.02em;color:var(--amc-live-artifact-muted);white-space:nowrap;">Recommendation</th></tr></thead>
    <tbody>
...
- Fake KPI dashboards on explanatory questions → Deep Tech Explainer mode: flowing narrative, inline Graphviz diagrams, and centered math. Reserve metric cards strictly for quantifiable benchmarks or telemetry.
...
- Badge/pill flood in comparison tables or card grids (pill fatigue) → highlight comparison winners with semibold text, subtle dots (●), or row tinting; reserve pill badges strictly for genuine status/states.

## Pre-output checklist
1. Root: display:block;width:100%;box-sizing:border-box;max-width:100%;overflow-wrap:anywhere; no style/script tags.
2. Structure: Hierarchy readable at a glance; wide content wrapped in overflow-x:auto; sticky thead for >4 row tables; no fake KPI cards on conceptual questions.
