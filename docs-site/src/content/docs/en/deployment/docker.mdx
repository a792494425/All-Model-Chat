...
### Option 1: Pull Official GHCR Prebuilt Images (Recommended)

To run AMC WebUI without building from source, use the official multi-arch images (`linux/amd64` and `linux/arm64`):
